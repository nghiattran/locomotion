...
public class TestSwitcher : MonoBehaviour {
	...
	// 	else return;
	// 	currentAnimation = analyzer.GetComponent<Animation>();
	// 	StartAnimation();
	...
	// 		if (newMotion!=null) optionsAnimation[i] = legC.motions[i].GetComponent<Animation>().name;
	...
	// 		if (currentCharacter.GetComponent<Animation>()[currentAnimation.name].speed == 0) currentCharacter.animation[currentAnimation.name].speed = 1;
	...
	// 			Mathf.Floor(
	// 				currentCharacter.animGetComponent<Animation>()[currentAnimation.name].normalizedTime
