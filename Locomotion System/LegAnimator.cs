	...
	private void ResetMotionStates() {
		...
		for (int g=0; g<motionGroupStates.Length; g++) {
			...
			if (controller==null) {
				...
				animation.AddClip(newLegCAnim, legC.motionGroups[g].name);
